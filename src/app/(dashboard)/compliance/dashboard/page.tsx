...
export default function ComplianceDashboard() {
  ...
  return (
    <VStack spacing={6} align="stretch">
      <Box>
        <Heading size="lg">Compliance Dashboard</Heading>
        <Text fontSize="sm" color="gray.500">Monitor your compliance review activity</Text>
      </Box>

      {/* Today Stats */}
      <Text fontSize="sm" fontWeight="600" color="gray.500" textTransform="uppercase" letterSpacing="wide">Today</Text>
      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6}>
        <StatCard label="Pending Reviews" value={stats.pending} icon={ClipboardCheck} iconColor="gray.400" />
      ...
      <Box>
        <Link href="/compliance/reviews">
          <Button colorScheme="brand">View All Submissions</Button>
        </Link>
      </Box>
    </VStack>
  );
